...
class Mo2CtlArchiveTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        (self.root / "mods" / "Core Mod").mkdir()
        (self.root / "mods" / "Core Mod" / "core.esp").write_text("", encoding="utf-8")
        self.profile.mkdir(parents=True)
        (self.profile / "modlist.txt").write_bytes(b"# This file was automatically generated by Mod Organizer.\r\n+Core Mod\r\n-Old Mod\r\n")
        (self.profile / "plugins.txt").write_bytes(
    ...
    def test_priority_after_mod_inserts_plugin_after_its_last_plugin(self) -> None:
        archive = self.zipfile("AfterCore.zip", {"Data/AfterCore.esp": ""})

        mo2ctl.cmd_install(self.env, self.args(archive, name="AfterCore", priority="after:Core Mod"))

        self.assertEqual(
            (self.profile / "plugins.txt").read_bytes(),
            b"# This file was automatically generated by Mod Organizer.\r\n"
            b"*core.esp\r\n"
            b"*AfterCore.esp\r\n"
            b"*zzz.esp\r\n",
        ...
        self.assertEqual(
            (self.profile / "loadorder.txt").read_bytes(),
            b"# This file was automatically generated by Mod Organizer.\r\n"
            b"core.esp\r\n"
            b"AfterCore.esp\r\n"
            b"zzz.esp\r\n",
    ...
    def test_plugin_after_overrides_priority_anchor(self) -> None:
        archive = self.zipfile("Explicit.zip", {"Data/Explicit.esp": ""})
        ...
        mo2ctl.cmd_install(
            ...
            self.args(
                archive,
                name="Explicit",
                priority="before:Core Mod",
                plugin_after="core.esp",
            ),
        )

        self.assertEqual(
            (self.profile / "plugins.txt").read_bytes().splitlines()[-3:],
            [b"*core.esp", b"*Explicit.esp", b"*zzz.esp"],
        )
        self.assertEqual(
            (self.profile / "loadorder.txt").read_bytes().splitlines()[-3:],
            [b"core.esp", b"Explicit.esp", b"zzz.esp"],
        )

    def test_priority_anchor_mod_without_active_plugin_appends(self) -> None:
        (self.root / "mods" / "Old Mod").mkdir()
        archive = self.zipfile("AfterOld.zip", {"Data/AfterOld.esp": ""})

        mo2ctl.cmd_install(self.env, self.args(archive, name="AfterOld", priority="after:Old Mod"))

        self.assertEqual(
            (self.profile / "plugins.txt").read_bytes().splitlines()[-2:],
            [b"*zzz.esp", b"*AfterOld.esp"],
        )
        self.assertEqual(
            (self.profile / "loadorder.txt").read_bytes().splitlines()[-2:],
            [b"zzz.esp", b"AfterOld.esp"],
        )

    def test_add_plugins_activates_existing_disabled_line_in_place(self) -> None:
        (self.profile / "plugins.txt").write_bytes(
            b"# This file was automatically generated by Mod Organizer.\r\n"
            b"*core.esp\r\n"
            b"Foo.esp\r\n"
        ...
        activated = mo2ctl.add_plugins(self.env, ["Foo.esp"])

        self.assertEqual(activated, ["Foo.esp"])
        self.assertEqual(
            (self.profile / "plugins.txt").read_bytes(),
            b"# This file was automatically generated by Mod Organizer.\r\n"
            b"*core.esp\r\n"
    ...
    def test_plugin_after_missing_anchor_fails(self) -> None:
        archive = self.zipfile("MissingAnchor.zip", {"Data/MissingAnchor.esp": ""})

        with self.assertRaisesRegex(mo2ctl.Fail, "plugin anchor not found"):
            mo2ctl.cmd_install(
                self.env,
